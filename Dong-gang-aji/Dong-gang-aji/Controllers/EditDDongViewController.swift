...
final class EditDDongViewController: UIViewController {

    @IBOutlet weak var tableView: UITableView!
   
    var viewModel : EditDDongViewModel!
...
extension EditDDongViewController : UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        viewModel.selectRow(at: indexPath )
        tableView.deselectRow(at: indexPath, animated: false)
    }
}
extension EditDDongViewController : UITableViewDataSource {
...
extension EditDDongViewController : UITextFieldDelegate {
